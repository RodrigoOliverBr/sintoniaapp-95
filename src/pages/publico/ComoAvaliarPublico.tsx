...
const ComoAvaliarPublico: React.FC = () => {
  return (
    <SimpleLayout title="Como Avaliar">
                  ...
                  <div className="p-4 border rounded-lg bg-severity-medium/10 border-severity-medium/30">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          <strong>Interpretação:</strong> Indica um risco significativo que afeta diretamente
                  ...
                  <ol className="list-decimal pl-5 space-y-2">
                    <li>
                      ...
                      <p className="text-muted-foreground mt-1">
                        Avalie a proporção de respostas "Sim" em relação ao total de perguntas, entendendo
                        o panorama geral dos riscos.
                      </p>
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                      <li>
                        <span className="font-medium">Priorização por severidade:</span> Abordar primeiro
                        as questões extremamente prejudiciais, seguidas pelas prejudiciais.
                      </li>
                      <li>
                        <span className="font-medium">Ações de curto prazo:</span> Implementar medidas
                        imediatas para estabilizar situações críticas (ex: afastamento em casos de assédio).
                      </li>
                      <li>
                        <span className="font-medium">Ações de médio prazo:</span> Desenvolver programas
                        e políticas para resolver as causas raiz dos problemas identificados.
                      </li>
                      <li>
                        <span className="font-medium">Ações de longo prazo:</span> Estabelecer mudanças
                        na cultura organizacional e capacitar lideranças para prevenir recorrências.
                      </li>
                      <li>
                        <span className="font-medium">Monitoramento contínuo:</span> Estabelecer indicadores
                        e acompanhar a evolução dos riscos psicossociais ao longo do tempo.
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <Card className="mb-6">
              ...
              <CardContent className="space-y-6">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    A versão brasileira foi adaptada considerando as particularidades do contexto laboral
                    do Brasil e está alinhada às exigências da Norma Regulamentadora nº 01 (NR-01), que
                    estabelece disposições gerais e gerenciamento de riscos ocupacionais.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-3">
                    O principal objetivo do formulário ISTAS21-BR é identificar, avaliar e monitorar os
                    fatores de risco psicossocial presentes no ambiente de trabalho que podem afetar a
                    saúde mental e o bem-estar dos trabalhadores.
                  </p>
                  <p className="text-muted-foreground">O instrumento permite:</p>
                  <ul className="list-disc pl-5 space-y-2 mt-2">
                    <li>Mapear os principais riscos psicossociais presentes na organização</li>
                    <li>Avaliar a severidade e o impacto potencial desses riscos</li>
                    <li>Identificar áreas que necessitam de intervenção prioritária</li>
                    <li>Estabelecer uma base para o desenvolvimento de programas de prevenção</li>
                    <li>Monitorar a evolução dos riscos psicossociais ao longo do tempo</li>
                    <li>Atender às exigências legais relacionadas à gestão de riscos ocupacionais</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Avalia exigências cognitivas e emocionais no trabalho, pressão por resultados e
                        prazos, necessidade de esconder emoções.
                      </p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Examina relações interpessoais, apoio de superiores e colegas, qualidade da gestão
                        e comunicação.
                      </p>
                    </div>
                    <div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-3">O ISTAS21-BR pode ser utilizado pelas empresas como:</p>
                  <ul className="list-disc pl-5 space-y-2">
                    <li>
                      <span className="font-medium">Ferramenta diagnóstica:</span> Para identificar os
                      principais riscos psicossociais presentes no ambiente de trabalho.
                    </li>
                    <li>
                      <span className="font-medium">Instrumento de compliance:</span> Para atender às
                      exigências da NR-01 relacionadas à gestão de riscos psicossociais.
                    </li>
                    <li>
                      <span className="font-medium">Base para programas preventivos:</span> Orientando o
                      desenvolvimento de ações de promoção da saúde mental no trabalho.
                    </li>
                    <li>
                      <span className="font-medium">Indicador de saúde organizacional:</span> Permitindo
                      o monitoramento contínuo da qualidade do ambiente psicossocial.
                    </li>
                    <li>
                      <span className="font-medium">Evidência para defesa legal:</span> Documentando as
                      ações da empresa para gerenciar riscos psicossociais em caso de reclamações
                      trabalhistas.
                    </li>
                  </ul>
            ...
            <Card className="mb-6">
              ...
              <CardContent>
                <p className="text-muted-foreground mb-6">
                  ...
                  psicossociais identificados através do ISTAS21-BR. As medidas estão organizadas por
                  categorias, abordando diferentes aspectos do ambiente de trabalho que podem afetar a
...
export default ComoAvaliarPublico;
