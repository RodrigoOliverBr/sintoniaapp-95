...
const ComoPreencherPublico: React.FC = () => {
  return (
    <SimpleLayout title="Como Preencher">
          ...
          <CardContent className="space-y-6">
              ...
              <ol className="list-decimal pl-5 space-y-3">
                <li>
                  ...
                  <p className="text-muted-foreground mt-1">
                    Certifique-se de entender completamente o que está sendo perguntado antes de responder.
                  </p>
                </li>
                <li>
                  <span className="font-medium">Observe o período de referência:</span>{" "}
                  <p className="text-muted-foreground mt-1">
                    Algumas perguntas se referem às últimas duas semanas, outras às últimas quatro semanas.
                    Considere apenas eventos ocorridos nestes períodos.
                  </p>
                </li>
                <li>
                  <span className="font-medium">Responda com sinceridade:</span>{" "}
                  <p className="text-muted-foreground mt-1">
                    O objetivo é melhorar condições de trabalho, não encontrar culpados. Respostas sinceras
                    ajudarão a criar um ambiente mais saudável.
                  </p>
                </li>
                <li>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start gap-2 p-3 rounded-lg border">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Indica que a situação descrita ocorreu no período especificado, podendo representar
                ...
                <div className="flex items-start gap-2 p-3 rounded-lg border">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Indica que a situação descrita não ocorreu no período especificado, não representando
                      um risco psicossocial naquele aspecto.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>Complete o formulário em um ambiente tranquilo e sem interrupções.</li>
                <li>Não se apresse nas respostas; reflita sobre cada situação apresentada.</li>
                <li>Caso uma pergunta não se aplique à sua realidade, assinale "Não".</li>
                <li>O preenchimento do formulário é confidencial e visa melhorar o ambiente de trabalho.</li>
                <li>Ao finalizar, revise suas respostas antes de visualizar os resultados.</li>
              </ul>
            </div>
          </CardContent>
        </Card>
...
export default ComoPreencherPublico;
