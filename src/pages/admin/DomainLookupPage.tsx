...
import { Search, Globe, CheckCircle2, XCircle, Calendar, Server, Building2, RefreshCw, AlertCircle } from "lucide-react";
  ...
  if (data.available) {
    return (
      <div className="flex flex-col items-center py-8 gap-3">
        ...
        <Badge className="bg-green-100 text-green-800 border-green-200 text-sm px-3 py-1" variant="outline">
        ...
        <>
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-xs text-gray-500 font-medium uppercase tracking-wide">Servidores DNS</p>
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex gap-2">
              ...
              />
              <Button onClick={handleLookup} disabled={isLoading || !domain.trim()} className="shrink-0">
                {isLoading ? (
            ...
            <p className="text-xs text-gray-400 mt-2">
              Dados fornecidos via protocolo RDAP (Registration Data Access Protocol) — público e gratuito.
            </p>
          </CardContent>
        </Card>
